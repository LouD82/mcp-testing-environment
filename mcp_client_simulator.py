...
async def interactive_session(client: MCPClientSimulator):
    ...
    print("╔════════════════════════════════════════════════════════════════════════════╗")
    print("║                                                                            ║")
    print("║                     MCP CLIENT SIMULATOR - HUMAN-FIRST TESTING             ║")
    print("║                                                                            ║")
    print("║  IMPORTANT: Always start testing with natural user queries and interactions ║")
    print("║  before examining code or logs. Test as a human would use the MCP server.   ║")
    print("║                                                                            ║")
    print("║  Example queries:                                                          ║")
    print("║  - \"Has anything been said about [topic] recently?\"                        ║")
    print("║  - \"What were the main discussions in [channel] yesterday?\"                ║")
    print("║  - \"Who are the most active users in the server?\"                          ║")
    print("║                                                                            ║")
    print("╚════════════════════════════════════════════════════════════════════════════╝")
    print("\n")
    ...
    print("  query <text> - Send a natural language query (RECOMMENDED STARTING POINT)")
